const HomePage = () => {
  ...
  <div class= "box">
    <div class="title">
      ...
      <img class = "image1" src="https://post.medicalnewstoday.com/wp-content/uploads/2019/05/111643-Tampons_vs_Pads-The_Ultimate_ShowdownThumbnail.jpg" alt="Menstrual helper image"></img>
      </div>
    </div>
    ...
    <div class="about">
      ...
      <img class = "image2" src="https://lh3.googleusercontent.com/pw/ACtC-3dGL29HN-Pg-mCcWG9ik42pie60cLnmXHh66wJqZuzVKYItyIEkGDGYOFD83BNZCipzTmgegUu9epw-0sVekqHJx343k1bhGHk2leOeTPQKXq4A6RvvvAYmGextp-hkm9SI_vJ13oHv7gXAw_Ai1dLR4Q=w446-h404-no" alt="Support image"></img>
      </div>
    </div>
